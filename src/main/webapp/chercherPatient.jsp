...
<div class="topnav">
  <a   href="listeConsultations.jsp">Gestion des consultations</a>
    ...
    <a class="active" href="chercherPatient.jsp">Chercher les consultations d'un patient</a>
...
<c:if test="${(c.patient.idP == idP) && (c.intervenant.username == userName) }">
    <tr >
